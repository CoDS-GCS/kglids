...
class IntProfileCreator(NumericalProfileCreator):
    ...
    def __init__(self, column: pd.Series, table: Table):
        ...
        embedding_model_path = os.path.join(basedir, 'column_embeddings/pretrained_models/int/20230123140419_int_model_embedding_epoch_100.pt')
        scaling_model_path = os.path.join(basedir, 'column_embeddings/pretrained_models/int/20230123140419_int_model_scaling_epoch_100.pt')
