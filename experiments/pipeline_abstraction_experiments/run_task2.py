...
def train_and_evaluate_classification_model(train_graphs, val_graphs, test_graphs, train_labels, val_labels,
                                            test_labels, epochs=100,
...
wandb.init(project="task2-classical-vs-deep",
...
train_and_evaluate_classification_model(train_graphs=[kglids_stellargraph[i] for i in train_names],
                                        ...
                                        epochs=wandb.config.epochs, batch_size=50,
                                        sysname='KGLiDS')
d1 = datetime.now()
